...
import bgimage from "./card9 bg.png"; // Import the background image
...
const Card9 = ({
  ...
  return (
    <div className="w-[500px] translate-x-10 flex flex-col items-center justify-around overflow-visible gap-y-20">
      <div
        ref={cardRef}
      ...
      >
        ...
        <div className="flex items-center p-6  bg-opacity-60">
          ...
          />
          <div
            className="ml-3 bg-pink-100 rounded-xl 
          "
          >
            <ul>
              <li className="mb-1">
