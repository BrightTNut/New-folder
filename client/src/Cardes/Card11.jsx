...
import bgimage from "./card11 bg.png"; // Import the background image
    ...
    <div className="w-[500px] translate-x-10 flex flex-col items-center justify-around overflow-visible ">
      ...
      >
        ...
        <div className="flex flex-col items-center p-6  bg-opacity-60">
          <img
            className="w-[160px] h-[170px] rounded-lg shadow-lg shadow-black  mx-auto pt-5 pl-2"
            src={image}
            alt="Student"
          />
          <div className=" text-center py-4 px-6 bg-opacity-60">
          ...
          <div
            className="ml-6 rounded-xl p-3 text-blue-200
          "
          >
            <ul>
              <li className="mb-1">
